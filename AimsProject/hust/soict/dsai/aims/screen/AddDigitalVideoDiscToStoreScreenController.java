...
public class AddDigitalVideoDiscToStoreScreenController extends AddItemToStoreScreenController {
	...
	public AddDigitalVideoDiscToStoreScreenController(Store store, Cart cart, JFrame stage) {

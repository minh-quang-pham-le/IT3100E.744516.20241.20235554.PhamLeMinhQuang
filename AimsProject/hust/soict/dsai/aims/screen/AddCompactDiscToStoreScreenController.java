...
public class AddCompactDiscToStoreScreenController extends AddItemToStoreScreenController {
	...
	public AddCompactDiscToStoreScreenController(Store store, Cart cart, JFrame stage) {
